...
/** BIRD Phase Color Mapping (Deep Green + Gold palette) */
export const PHASE_COLORS: Record<string, { bg: string; text: string; border: string; badge: string; bar: string }> = {
  '01': { bg: 'bg-[#064e3b]', text: 'text-[#ecfdf5]', border: 'border-[#059669]/30', badge: 'bg-[#059669]/20 text-[#6ee7b7]', bar: 'bg-[#059669]' },
  '02': { bg: 'bg-[#065f46]', text: 'text-[#ecfdf5]', border: 'border-[#10b981]/30', badge: 'bg-[#10b981]/20 text-[#34d399]', bar: 'bg-[#10b981]' },
  '03': { bg: 'bg-[#C9A84C]', text: 'text-[#022c22]', border: 'border-[#E8C560]/30', badge: 'bg-[#C9A84C]/20 text-[#E8C560]', bar: 'bg-[#C9A84C]' },
};
