      ...
      <header className="h-16 border-b border-white/5 bg-[#022c22]/80 backdrop-blur-md flex items-center justify-between px-4 sticky top-0 z-50">
            ...
            <TooltipTrigger asChild>
              <button
                ...
                className={cn(
                  ...
                  'hover:from-[#E8C560] hover:via-[#C9A84C] hover:to-[#F0D78C]',
                  'border border-[#E8C560]/40 shadow-lg shadow-[#C9A84C]/20',
                  'transition-all duration-200 hover:scale-105',
                  'focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#E8C560]/60'
                )}
                aria-label="Open navigation menu"
              >
                <Menu className="w-4 h-4 text-[#022c22]" />
              </button>
            </TooltipTrigger>
            <TooltipContent side="bottom" className="bg-[#022c22] border-[#C9A84C]/30 text-[#E8C560]">
        ...
        <div className="flex items-center gap-2">
          ...
          <Tooltip>
            ...
            <TooltipContent side="bottom" className="bg-[#022c22] border-[#C9A84C]/30 text-[#E8C560]">
              <p className="text-xs">Open Validation Survey</p>
            </TooltipContent>
          </Tooltip>
          ...
          <div className="relative" ref={searchRef} id="topbar-search-wrapper">
            ...
            <Tooltip>
              ...
              <TooltipContent side="bottom" className="bg-[#022c22] border-[#C9A84C]/30 text-[#E8C560]">
                <p className="text-xs">{showMobileSearch ? 'Close search' : 'Search plans'}</p>
              </TooltipContent>
            </Tooltip>
          ...
          {/* Theme toggle — wired to theme-provider with ToggleGroup */}
          <ToggleGroup
            type="single"
            value={theme}
            onValueChange={(value) => value && setTheme(value as 'light' | 'dark' | 'system')}
            className="bg-white/5 border border-white/10 rounded-xl p-0.5"
          >
            <Tooltip>
              <TooltipTrigger asChild>
                <ToggleGroupItem
                  ...
                  className={cn(
                    'h-8 w-8 rounded-lg data-[state=on]:bg-[#C9A84C]/20 data-[state=on]:text-[#E8C560',
                    'text-[#64748b]/80 hover:text-[#ecfdf5]/90 transition-colors'
                  )}
                >
            ...
            <Tooltip>
              ...
              <TooltipContent side="bottom" className="bg-[#022c22] border-[#C9A84C]/30 text-[#E8C560]">
                <p className="text-xs">System preference</p>
              </TooltipContent>
            </Tooltip>
          </ToggleGroup>
          ...
          {isAuthenticated ? (
            <div className="relative" ref={accountRef}>
              <Tooltip>
                ...
                <TooltipContent side="bottom" className="bg-[#022c22] border-[#C9A84C]/30 text-[#E8C560]">
                  <p className="text-xs">{userName} — {isAdmin ? 'Admin' : 'Member'}</p>
                </TooltipContent>
              </Tooltip>
