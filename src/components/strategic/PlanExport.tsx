...
const ARCHETYPE_DATA: Record<string, any> = {
  ...
  success_to_the_successful: {
    ...
    leverage_points: ['Affirmative investment policies', 'Provincial equity targets', 'Satellite BBOI offices in Tawi-Tawi, Basilan, SGA'],
...
const PlanExport: React.FC<PlanExportProps> = ({ plan }) => {
  ...
  const generateExportContent = () => {
    ...
    content += `  * COVERAGE GAP: Basilan and Tawi-Tawi returned ZERO\n`;
    ...
    content += `    the SGA and statistical residual - is\n`;
                ...
                <div className="text-center py-12 border-b border-[#C9A84C]/20 print:break-after-page">
                  ...
                  <div className="mt-6 mx-auto max-w-lg text-left rounded-lg border border-[#C9A84C]/30 bg-[#064e3b]/10 px-4 py-3">
                    ...
                    <p className="text-[0.7rem] text-[#ecfdf5]/70 leading-relaxed">
                      ...
                      Zero respondents from Basilan and Tawi-Tawi. Full methodology in the exported document.
                    </p>
                  </div>
                </div>
              )}
